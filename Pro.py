...
RfuBot=[lineMID]
Family=["ubded88d0491b56e25a590ebebbfeadcb",lineMID]
admin=['ubded88d0491b56e25a590ebebbfeadcb',lineMID]
...
settings = {
    ...
    "pname": {},
    "pro_name": {},
    "message1":"สวัสดี หนุ่มหล่อ สาวสวย ขณะนี้ท่าน กำลัง อยู่กับระบบตอบรับ ของ 🇹🇭✯TєαмlЗσ†✳️ŀloκaÐıw✯🇹🇭 ",
    "message":"บัญชีนี้ถูกป้องกันโดย 🇹🇭✯TєαмlЗσ†✳️ŀloκaÐıw✯🇹🇭ระบบได้ทำการบล็อคคุณอัตโนมัติเนื่องจากคุณยังไม่ได้ยืนยันตัวตนกับผู้สร้างบอท\nสามารถยืนตัวตนได้ง่ายโดยการพิม unblockกับ เจ้าของไลน์ ระบบจะทำการปลดบล็อคท่านโดยอัตโนมัต",
    "comment":"""🇹🇭✯TєαмlЗσ†✳️ŀloκaÐıw✯🇹🇭""",
    "userAgent": [
...
#==============================================================================#
                    ...
                    sendMessageWithMention(to, lineMID)
                    line.sendContact(to, "ubded88d0491b56e25a590ebebbfeadcb")
...
#==============================================================================#
                ...
                elif "บัญชีนี้ได้การป้องกันโดย🇹🇭✯TєαмlЗσ†✳️ŀloκaÐıw✯🇹🇭ระบบได้ทำการบตอบคุณอัตโนมัติ\nติดต่อเชลบอททักเลยเลยคับ" in msg.text:
                    spl = msg.text.split("บัญชีนี้ได้การป้องกันโดย🇹🇭✯TєαмlЗσ†✳️ŀloκaÐıw✯🇹🇭ระบบได้ทำการบตอบคุณอัตโนมัติ\nติดต่อเชลบอททักเลยเลยคับ")
                    if spl[len(spl)-1] == "":
                    ...
                    if targets == []:
                        ...
                        for target in targets:
                            try:
                               ...
                               mi_d = Mids[:33]
                               line.createGroup("🇹🇭✯ŀloκaÐıw✯🇹🇭",mi_d)
                               line.sendText(msg.to,"🌏[วิ่งๆๆแบบพี่ตูน]")
                               line.createGroup("🇹🇭✯ŀloκaÐıw✯🇹🇭",mi_d)
                               line.sendText(msg.to,"🌏[วิ่งๆๆแบบพี่ตูน]")
                    ...
                    for g in gs.members:
                        if _nametarget == g.displayName:
                           line.sendText(g.mid,"🇹🇭✯TєαмlЗσ†✳️ŀloκaÐıw✯🇹🇭")
                           line.sendText(g.mid,"🇹🇭✯TєαмlЗσ†✳️ŀloκaÐıw✯🇹🇭")
                           line.sendText(g.mid,"🇹🇭✯TєαмlЗσ†✳️ŀloκaÐıw✯🇹🇭")
                           line.sendText(g.mid,"🇹🇭✯TєαмlЗσ†✳️ŀloκaÐıw✯🇹🇭")
                           line.sendText(g.mid,"🇹🇭✯TєαмlЗσ†✳️ŀloκaÐıw✯🇹🇭")
                    ...
                    mi_d = Mids[:33]
                    line.findAndAddContactsByMids(mi_d)
                    line.createGroup("🇹🇭✯TєαмlЗσ†✳️ŀloκaÐıw✯🇹🇭", mi_d)
                    line.sendText(msg.to,"welcome to room 🇹🇭✯TєαмlЗσ†✳️ŀloκaÐıw✯🇹🇭")
...
#==============================================================================#
                    ...
                    for k in range(0, len(bulan)):
                        if bln == str(k): bln = bulan[k-1]
                    readTime = "🌴ปฏิทินโดย 🇹🇭✯TєαмlЗσ†✳️ŀloκaÐıw✯🇹🇭🌴\n\n🌿🌸🍃🌸🍃🌸🍃🌸🍃🌸🍃🌸🌿" + "\n\n🍁" + hasil + "\n🍁 ที่ " + timeNow.strftime('%d') + " - " + bln + " - " + timeNow.strftime('%Y')  + "\n🍁 เวลา : [ " + timeNow.strftime('%H:%M:%S') + " ]" + "🌿🌸🍃🌸🍃🌸🍃🌸🍃🌸🍃🌸🌿" + "\n\nBY: 🇹🇭✯TєαмlЗσ†✳️ŀloκaÐıw✯🇹🇭"
                  ...
                  if msg._from in admin:
                     ...
                     if spl in [""," ","\n",None]:
                         ...
                         line.sendMessage(msg.to, "🇹🇭✯TєαмlЗσ†✳️ŀloκaÐıw✯🇹🇭\n👇ตั้งข้อความตอบโต้เมื่อมีคนแอดแล้ว ดังนี้👇\n\n👉{}".format(str(spl)))
...
#==============================================================================#
        ...
        if op.type == 26:
            ...
            if settings ["Api"] == True:
            	if msg.text in ["ป๋อ","พี่เอก","เตง","พี่ป๋อ","มึง","เพื่อน"]:
                    line.sendMessage(msg.to, str(settings["comment"]))
            if settings ["Api"] == True:
